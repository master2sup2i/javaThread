	public class TrierThread extends Thread
	{
		  /**
		   * Tableau à trier.
		   */
		  ...
		  public TrierThread(int[] t, int debut, int fin) {
		    this.t = t;
		    this.debut = debut;
		    this.fin = fin;
		  }
		  ...
		  public void run() {
		    if (fin - debut < 2) {
		      ...
		      TrierThread T1 = new TrierThread (t,debut,milieu);
		      TrierThread T2 = new TrierThread (t,milieu+1,fin);
		      T1.start();
		      T2.start();
		      try {
				T1.join();T2.join();
